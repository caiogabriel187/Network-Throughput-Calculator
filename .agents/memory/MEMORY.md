...
- [Expo publish Metro HTTP 500 mid-bundle](expo-deploy-metro-500-transient.md) — same-% failure each publish = deterministic build OOM, not transient; cap Metro workers + raise Node heap.
